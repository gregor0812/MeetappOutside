...
/**
 * Created by Gregor on 23/03/2017.
 */
...
public class BackgroundTask extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String urlRegistration = "http://arendan.tech/LoginAndRegister-register.php";
        String urlLogin = "http://arendan.tech/LoginAndRegister-login.php";
